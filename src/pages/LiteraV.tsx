...
const LiteraV: React.FC<RouteComponentProps> = ({ history }) => {
    const images1 = [vaca, val, vapor, vaza];
    const images2 = [vesta, veverita, vioara, vulcan];
    const audios = [VacaAudio, ValAudio, VaporAudio, VazaAudio, VestaAudio, VeveritaAudio, VioaraAudio, VulcanAudio];
    const words1 = ['VACA', 'VAL', 'VAPOR', 'VAZA']; // Text pentru primul rând
    const words2 = ['VESTA', 'VEVERITA', 'VIOARA', 'VULCAN']; // Text pentru al doilea rând
