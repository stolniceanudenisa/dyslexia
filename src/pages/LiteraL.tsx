...
const LiteraL: React.FC<RouteComponentProps> = ({ history }) => {
    const images1 = [lac, lacat, lacrimioara, lalea];
    const images2 = [lamaie, leu, libelula, lumanare];
    const audios = [LacAudio, LacatAudio, LacrimioaraAudio, LaleaAudio, LamaieAudio, LeuAudio, LibelulaAudio, LumanareAudio];
    const words1 = ['LAC', 'LACAT', 'LACRIMIOARA', 'LALEA']; // Text pentru primul rând
    const words2 = ['LAMAIE', 'LEU', 'LIBELULA', 'LUMANARE']; // Text pentru al doilea rând
