...
const LiteraELevel1: React.FC<RouteComponentProps> = ({ history }) => {
    ...
    const completeLevelE1 = () => {
        localStorage.setItem('levelE1Completed', 'true');  
        history.push('/LiteraELevel2'); 
      };
    ...
    return (
        ...
        <IonFabButton className="custom-home-button" onClick={() => history.push('/map1')}>
          <span className="custom-home-emoji" title="Go to Map">🏠</span>
                ...
                <IonFabButton onClick={completeLevelE1} disabled={isNextLevelDisabled}>
                        <IonIcon
