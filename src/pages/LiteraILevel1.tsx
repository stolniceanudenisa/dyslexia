...
const LiteraILevel1: React.FC<{ history: any }> = ({ history }) => {
    ...
    const completeLevelI1 = () => {
        localStorage.setItem('levelI1Completed', 'true');  
        history.push('/LiteraILevel2'); 
      };
        ...
        <IonFabButton className="custom-home-button" onClick={() => history.push('/map1')}>
          <span className="custom-home-emoji" title="Go to Map">🏠</span>
                ...
                <IonFab vertical="bottom" horizontal="end" slot="fixed">
                     <IonFabButton onClick={completeLevelI1} disabled={isNextLevelDisabled}>
                        <IonIcon
